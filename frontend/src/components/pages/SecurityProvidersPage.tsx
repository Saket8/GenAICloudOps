...
export function SecurityProvidersPage() {
                ...
                <div className="flex items-center justify-between mb-8">
                    <div className="text-center flex-1">
                        ...
                        <p className="mt-2 text-gray-600 dark:text-gray-400 max-w-2xl mx-auto">
                            Select a cloud provider to view security dashboards and access analysis
                        </p>
                    </div>
                        ...
                        <div className="flex flex-col lg:flex-row lg:items-start lg:justify-between gap-6 mb-6">
                            <div>
                                <div className="flex items-center space-x-3">
                                    <h2 className="text-2xl font-semibold text-gray-900 dark:text-white">Security Providers</h2>
                                ...
                                <p className="mt-2 text-sm text-gray-600 dark:text-gray-400 max-w-xl">
                                    Select the cloud provider you want to explore. Continue to open the tailored security dashboard for that environment.
                                </p>
                            </div>
