...
async def get_vault_statistics(
    ...
    try:
        # Get all secrets
        secrets = await get_vault_service().list_secrets()
        ...
        # Get cache stats
        cache_stats = get_vault_service().get_cache_stats()
...
async def list_secrets(
    ...
    try:
        ...
        secrets = await get_vault_service().list_secrets(filter_type)
...
async def create_secret(
    ...
    try:
        success = await get_vault_service().store_secret(
...
async def rotate_secret(
    ...
    try:
        success = await get_vault_service().rotate_secret(secret_name, request.value)
...
async def delete_secret(
    ...
    try:
        success = await get_vault_service().delete_secret(secret_name, permanent=permanent)
