...
async def lifespan(app: FastAPI):
    ...
    try:
        # TEMPORARILY DISABLED: Real-time streaming causing stability issues
        # streaming_task = asyncio.create_task(start_realtime_streaming())
        # print("Real-time streaming service started")
        print("Real-time streaming DISABLED for stability")
        ...
        print("Performance monitoring DISABLED for debugging")
